...
describe("generateInternalBranchName", () => {
  it("always emits an eight-character internal branch id", () => {
    expect(generateInternalBranchName(() => 0)).toBe("mcode-00000000");
    expect(generateInternalBranchName(() => 1)).toBe("mcode-zzzzzzzz");
  });
});
