...
import { StackedLayersIcon } from "@/components/chat/narrative/StackedLayersIcon";
...
/** Props for the stable, identity-colored subagent glyph. */
...
/** Renders the canonical subagent silhouette with a deterministic identity color. */
