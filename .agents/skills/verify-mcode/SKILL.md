---
name: verify-mcode
description: Verify Mcode runtime, desktop, subagent, and managed-worktree workflows before merge. Use for AgentService, provider events, selected text comments, Codex subagents, thread completion, and cleanup changes.
---
